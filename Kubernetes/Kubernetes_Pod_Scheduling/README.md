...
spec:
  ...
  template:
    ...
    spec:
      ...
      affinity:
        nodeAffinity:
          preferredDuringSchedulingIgnoredDuringExecution:   # eger eslesen bulursa ona öncelik verir
          - weight: 1                                        # eslesenler arasinda hangisinin numarasi büyükse onda calistirir. Degere göre numara verilebilir     
            preference:                                     
              matchExpressions:
              - key: size
