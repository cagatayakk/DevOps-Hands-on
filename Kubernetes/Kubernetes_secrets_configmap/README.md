...
echo -n 'admin' > ./username.txt                    # "-n" satir sonunda enter yapmamasi icin kullanilir
...
```bash
$ kubectl create secret generic db-user-pass --from-file=./username.txt --from-file=./password.txt      # "generic" sifreleme türü olarak veriliyor
```
